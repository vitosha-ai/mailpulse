...
const COLS: { key: string; header: string; width: number }[] = [
  ...
  { key: "sdr", header: "SDR", width: 14 },
  { key: "contacted_at", header: "Contacted On", width: 13 },
  { key: "response", header: "Response", width: 26 },
  { key: "updated_at", header: "Last Update", width: 16 },
];
